...
while($row = $ret->fetchArray(SQLITE3_ASSOC) ){
    $ads[$row['position']]=$row['url'];
}

?>
<input id="mac" type="hidden" value="<?php echo $mac; ?>">
<div class="countainer">
    <div class="banner">
        <div class="flicker-example" data-block-text="false">
            <ul>
                <li data-background="letv.com/vedio/field.jpg" onclick=jumpAd("<?php echo $ads[1]; ?>",1)></li>
                <li data-background="letv.com/vedio/forest.jpg" onclick=jumpAd("<?php echo $ads[2]; ?>",2)></li>
                <li data-background="letv.com/vedio/frozen-water.jpg" onclick=jumpAd("<?php echo $ads[3]; ?>",3)></li>
            </ul>
        </div>
    </div>
    <div class="header">
        ...
        <div class="parts">
            ...
            <div class="part3">
                ...
                <div class="player">
                    ...
                    <a href=""><img src="img/refreshRed.png" height="5%" width="5%"
                                    style="float:right;margin:5% 5% 0 5%;" alt=""></a>
                    <h2>不得不爱-潘玮柏/玄子</h2>
                ...
                <div class="quba_display">
                    ...
                    <div class="quba_display2">
                        <ul class="quba_list2">
                            <li>
                                <a href="">
                                    <p><a href="http://www.qiushibaike.com/article/114396877" target="_blank">今天带我家的哈士奇去买菜</a>
                                    </p>
                                </a>
                                <div class="clr"></div>
                            </li>
                            <li>
                                <a href="">
                                    <p><a href=" http://www.qiushibaike.com/article/114398004" target="_blank">男生宿舍管理员是个大妈</a>
                                    </p>
                                </a>
                                <div class="clr"></div>
                            </li>
                            <li>
                                <a href="">
                                    <p><a href="http://www.qiushibaike.com/article/114392366" target="_blank">小时候睡觉喜欢摸着妈妈的脸</a>
                                    </p>
                                </a>
                                <div class="clr"></div>
                            </li>
                            <li>
                                <a href="">
                                    <p><a href="http://www.qiushibaike.com/article/114396990" target="_blank">儿子问我“老妈你知道世界首富是谁吗？</a>
                                    </p>
                                </a>
                                <div class="clr"></div>
                            </li>
            ...
            <div class="part7">
                ...
                <div class="hot_display">
                    <div class="flicker-example" data-block-text="false">
                        <ul>
                            <li data-background="img/tadu.jpg" onclick=jumpAd("<?php echo $ads[4]; ?>",4)>
                    ...
                    <div class="flick-sub-text">Heaven forbid this package you downloaded is broken. That wouldn't be embarrassing at all.</div> -->
                            ...
                            <li data-background="img/forest.jpg" onclick=jumpAd("<?php echo $ads[5]; ?>",5)></li>
                            <li data-background="img/frozen-water.jpg" onclick=jumpAd("<?php echo $ads[6]; ?>",6)></li>
                        </ul>
                    </div>
                    <ul class="hot_apps">
                        <li>
